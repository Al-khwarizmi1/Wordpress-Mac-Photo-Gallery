...
#############################################################
add_action('wp_ajax_macphotoupload', 'photo_upload_function');
add_action('wp_ajax_macalbajax', 'album_function');
add_action('wp_ajax_macphotoajax', 'photo_function');
add_action('wp_ajax_process-sortable', 'sort_function');
add_action('admin_init', 'macgallery_admin_init');
add_action('wp_ajax_macphotos', 'macphotos_function');
add_action('wp_ajax_macdownload', 'macdownload_function');
add_action('wp_ajax_macalblist', 'macalblist_function');
add_action('wp_ajax_macfbcomment', 'macfbcomment_function');
add_action('wp_ajax_macimageview', 'macimageview_function');
/* Album function to update the description for the photos */

function album_function() {
    require_once( dirname(__FILE__) . '/macalbajax.php');
}

function macimageview_function() {
    require_once( dirname(__FILE__) . '/mac_imageview.php');
}

function photo_function() {
    require_once( dirname(__FILE__) . '/macphtajax.php');
}

function macphotos_function() {
    require_once( dirname(__FILE__) . '/macPhotos.php');
}

function macdownload_function() {
    require_once( dirname(__FILE__) . '/macdownload.php');
}

function macfbcomment_function() {
    require_once( dirname(__FILE__) . '/macfbcomment.php');
}

function macalblist_function() {
...
function photo_upload_function() {
    global $wpdb;
...
function macgallery_admin_init() {
...
function macPage() {
    add_menu_page('Mac Photos', 'Mac Photos', 'administrator', 'macAlbum', 'show_macMenu', get_bloginfo('url') . '/wp-content/plugins/' . dirname(plugin_basename(__FILE__)) . '/images/icon.png');
