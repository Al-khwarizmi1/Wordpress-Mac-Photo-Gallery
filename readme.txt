...
1. **Mac Photo gallery(Front-end)**

2. **Preview Image** - Displays the detailed view of particular image.

3. **Preview Album** - Displays the detailed view of particular album.

4. **Upload Images** - Here you can upload images using Upload Method.

5. **Manage Albums** - Displays albums and details about the album.

6. **Import Albums** - Here you can import albums from Google picasa, Flickr and Facebook.

7. **Gallery settings** - You can control Gallery and Plugin here.
