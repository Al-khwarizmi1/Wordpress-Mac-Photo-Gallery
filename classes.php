...
/*
  ...
  Description: Wordpress Mac Doc Photogallery user defined classes
  Version: 1.0
  Author: Apptha
                    ...
                    for ($j = $no_of_row; $j >= 1; $j--) {
                        ...
                        for ($i = $k; $i <= $total; $i++) {
                            ...
                            if ($k <= $o) {
                                ...
                                $div .='<a class="dock-item" rel="facebox" href="' . $site_url . '/wp-admin/admin-ajax.php?action=macimageview&mac_phtid=' . $imgsrc[$s]['macPhoto_id'] . '&mac_albid=' . $imgsrc[$s]['macAlbum_id'] . '&limit=' . $maclimit . '">
...
// Default selected first album
                    ...
                    if ((file_exists($file_image)) && ($get_album_row->macAlbum_image != '')) {
                        ...
                        $div .='<li><a href="' . $site_url . '?page_id=' . $macGallid . '&albid=' . $get_album_row->macAlbum_id . '"><img class="mac-no-border" title="' . $albnam . '" src="' . $site_url . '/wp-content/plugins/' . dirname(plugin_basename(__FILE__)) . '/uploads/star.jpg"
                              alt="" style="height:112px;filter:alpha(opacity=30);  opacity:1.0;"/>
                              <span class="carousel_lefttxt">' . substr(trim($get_album_row->macAlbum_name, ' '), 0, 15) . '</span></a></li>';
                    } else {
                        $div .='<li><a href="' . $site_url . '?page_id=' . $macGallid . '&albid=' . $get_album_row->macAlbum_id . '"><img class="mac-no-border" title="' . $albnam . '" src="' . $site_url . '/wp-content/plugins/' . dirname(plugin_basename(__FILE__)) . '/uploads/star.jpg"
                    ...
                    foreach ($album_results as $dis_results) {
                        ...
                        <img class="mac-no-border" title="' . $dis_results->albumname . '" src="' . $path . '/' . $dis_results->macAlbum_image . '"
                         ...
                         <span class="carousel_lefttxt">' . substr(trim($dis_results->macAlbum_name, ' '), 0, 11) . '</span></a></li>';
                            ...
                            $div .='<li><a href="' . $site_url . '?page_id=' . $macGallid . '&albid=' . $dis_results->macAlbum_id . '">
                        <img class="mac-no-border" title="' . $albbname . '" src="' . $site_url . '/wp-content/plugins/' . dirname(plugin_basename(__FILE__)) . '/uploads/star.jpg"
                         alt=""  style="height:112px;filter:alpha(opacity=30);" />
                         <span class="carousel_lefttxt">' . substr(trim($dis_results->macAlbum_name, ' '), 0, 11) . '</span></a></li>';
                        } else {
                            $div .='<li><a href="' . $site_url . '?page_id=' . $macGallid . '&albid=' . $dis_results->macAlbum_id . '">
            ...
            foreach ($albDis as $albDisplay) {
                ...
                if ($albDisplay->macAlbum_image == '' && $photoCount == '0') {
                    $div .='<div class="inner_albim_image"><a class="thumbnail" href="' . $site_url . '/?page_id=' . $macGallid . '&albid=' . $macalbumid . '"><img title="' . $albDisplay->macAlbum_name . '" src="' . $site_url . '/wp-content/plugins/' . dirname(plugin_basename(__FILE__)) . '/uploads/star.jpg"></a></div>';
            ...
            $pagelist = pageList($_GET['pages'], $pages, $alb);
