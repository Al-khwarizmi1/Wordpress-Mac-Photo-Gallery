...
/*
  ...
  Description: Wordpress Mac Doc Photogallery Imgae view file
  Version: 1.0
  Author: Apptha
...
{
			  //left arrow
	case 1 :  $sendingLUrl = $site_url .'/wp-admin/admin-ajax.php?action=macimageview&mac_phtid='.$prev.'&mac_albid='.$macAlbId.'&limit='.$prev.'&flag=1&total='.$total.'&selfReload=1&date='.$photoDate;	
			  //right arrow
		 	  $sendingRUrl =$site_url .'/wp-admin/admin-ajax.php?action=macimageview&mac_phtid='.$next.'&mac_albid='.$macAlbId.'&limit='.$next.'&flag=1&total='.$total.'&selfReload=1&date='.$photoDate;
	break;
	case 2 :  $sendingLUrl = $site_url .'/wp-admin/admin-ajax.php?action=macimageview&mac_phtid='.$prev.'&mac_albid='.$macAlbId.'&limit='.$prev.'&flag=2&total='.$total;

			  $sendingRUrl = $site_url .'/wp-admin/admin-ajax.php?action=macimageview&mac_phtid='.$next.'&mac_albid='.$macAlbId.'&limit='.$next.'&flag=2&total='.$total;
			  
	break;	
	case 3 :
			  $sendingLUrl = $site_url .'/wp-admin/admin-ajax.php?action=macimageview&mac_phtid='.$prev.'&mac_albid='.$macAlbId.'&limit='.$prev.'&flag=3&total='.$total;

			  $sendingRUrl = $site_url .'/wp-admin/admin-ajax.php?action=macimageview&mac_phtid='.$next.'&mac_albid='.$macAlbId.'&limit='.$next.'&flag=3&total='.$total;
		
		
	break;	
	default:   $sendingLUrl = $site_url .'/wp-admin/admin-ajax.php?action=macimageview&mac_albid='.$mac_albid.'&limit='.$prev;
			   $sendingRUrl = $site_url .'/wp-admin/admin-ajax.php?action=macimageview&mac_albid='.$mac_albid.'&limit='.$next;
...
<div class="fb-right">
 <?php  if($macapi->show_download == 'allow')  { ?>
    <div class="download share-font"><a href="<?php echo $site_url.'/wp-admin/admin-ajax.php?action=macdownload&albid='.$downloadImg;?>">Download</a></div>
